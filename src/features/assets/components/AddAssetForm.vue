...
const fetchPlatforms = async () => {
  ...
  try {
    ...
    platforms.value = snapshot.docs.map(
      (doc) =>
        ({
          id: doc.id,
          ...doc.data()
...
<template>
  ...
  <form v-else class="space-y-6" @submit.prevent="handleSubmit">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
        ...
        <div v-else class="space-y-2">
          ...
          <p class="text-[10px] text-gray-500 italic">
            Se guardará automáticamente en tu lista de tipos.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div v-else class="space-y-2">
          ...
          />
          <p class="text-[10px] text-gray-500 italic">
            Se creará y guardará permanentemente para futuros assets.
          </p>
        </div>
      </div>
    </div>
    ...
    <div>
      <label for="currentValue" class="block text-sm font-medium text-gray-400"
        >Valor Actual (Total)</label
      >
