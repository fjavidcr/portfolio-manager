     ...
     <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-2 pb-4 border-b border-outline-variant/30">
            <div class="flex justify-between items-center">
                ...
                <span class="text-lg font-bold text-on-surface">{{ formatCurrency(monthlyCostOfLiving) }}</span>
            </div>
            <div class="flex justify-between items-center">
                <span class="text-sm font-medium text-secondary">Annual Cost of Living</span>
                <span class="text-lg font-bold text-on-surface">{{ formatCurrency(annualCostOfLiving) }}</span>
            </div>
        </div>
        ...
        <div class="space-y-6">
             ...
             <div class="space-y-1">
                 ...
                 <p class="text-[10px] text-secondary mt-1">Recommended for stability (6x Monthly Expenses)</p>
             </div>
             ...
             <div class="space-y-1">
                 <div class="flex justify-between text-xs">
                     ...
                     <span class="font-bold text-primary">{{ formatCurrency(targetRetirementReserve) }}</span>
                 </div>
                 <div class="h-2 bg-surface-container-high rounded-full overflow-hidden">
                     <div class="h-full bg-primary/50 w-full opacity-30"></div>
                 </div>
                 <p class="text-[10px] text-secondary mt-1">Goal for safe withdrawal rate (33x Annual Expenses)</p>
             </div>
        </div>
     </div>
  </div>
