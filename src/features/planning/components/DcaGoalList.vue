...
import { dcaStore, dcaStatus, updatePlanValues, addGoal, deleteGoal, totalDcaEuros } from '../stores/dcaStore'
...
<template>
  ...
  <div v-else class="bg-surface rounded-2xl shadow-sm border border-outline-variant/30 overflow-hidden">
    <div class="p-6 border-b border-outline-variant/30 flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
          <span class="text-[10px] font-black uppercase text-secondary tracking-widest">Disponible:</span>
          <div 
            class="badge font-mono font-bold border-none"
            :class="remainingFromBudget >= 0 ? 'bg-green-100 text-green-700 dark:bg-green-900/30' : 'bg-error/10 text-error'"
          >
        ...
        <div class="flex items-start justify-between gap-4">
          <div class="flex items-center gap-3">
            <div 
                ...
                :class="isCorrect(goal.id) ? 'bg-green-100 dark:bg-green-900/10 border-green-200 dark:border-green-800/50 text-green-600' : 'bg-amber-100 dark:bg-amber-900/10 border-amber-200 dark:border-amber-800/50 text-amber-600'"
            >
          ...
          <div class="text-right">
              ...
              <p class="text-[9px] font-black uppercase text-secondary/60 tracking-widest mt-1">del presupuesto</p>
          </div>
        </div>

        <div class="mt-2 bg-surface p-3 rounded-xl border border-outline-variant/30 flex items-center justify-between gap-4">
            <div class="space-y-0.5">
                <label class="text-[9px] font-black text-secondary uppercase tracking-widest block ml-1">Inversión Mensual</label>
            ...
            <div class="flex items-center gap-1.5 pr-1">
                ...
                <span 
                  ...
                  :class="isCorrect(goal.id) ? 'text-green-600 dark:text-green-500/80' : 'text-amber-600 dark:text-amber-500/80'"
                >
